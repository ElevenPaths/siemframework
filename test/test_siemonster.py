...
class TestSiemsframework(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.port = '443'
        self.url_base = 'https://siemonster.internal.co'
    ...
    def test_mcafee_brute(self, response):
        ...
        result = "\n\n\x1b[32m\x1b[1m[*] =================================" \
                 ...
                 "=========================================================" \
                 "========================= [*]"\
                 "\n[!] Username: \x1b[31m\x1b[1mNGCP" \
                 "\n[!] Password: \x1b[31m\x1b[1mhs+&8:fiY91" \
                 "\n\x1b[32m\x1b[22m[*] ===================================" \
                 "=========================================================" \
                 "================== [*]\x1b[0m\n"
    ...
    def test_smonster_ssh_bf(self):
        ...
        with patch('sys.stdout', new=StringIO()) as smonster_out:
            with patch('nmap.PortScanner.scan') as mock_nmap:
                with patch('paramiko.SSHClient.connect', autospec=True) as\
                    ...
                    smonster_ssh_bf(self.ip)
            self.assertEqual(smonster_out.getvalue(), result)
